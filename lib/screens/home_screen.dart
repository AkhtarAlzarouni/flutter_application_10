...
import 'package:flutter_application_10/screens/home_dark.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  IconButton(onPressed: (){
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => HOMEDARK()),
    );
              ...
              child: Container(
                ...
                child: Center(
                  child: Column(
                    ...
                    Text("JUN",style: TextStyle(color: Colors.white,fontSize: 16),),
                    Text("11",style: TextStyle(color: Colors.white,fontSize: 16),),
                    Text("FRI",style: TextStyle(color: Colors.white,fontSize: 16),),
              ...
              child: Container(
                ...
                child: Center(
                  child: Column(
                    ...
                    Text("SUN",style: TextStyle(color: Colors.white,fontSize: 16),),
              ...
              child: Container(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                    Text("JUN",style: TextStyle(color: Colors.white,fontSize: 16),),
                    Text("14",style: TextStyle(color: Colors.white,fontSize: 16),),
                    Text("MON",style: TextStyle(color: Colors.white,fontSize: 16),),
              ...
              child: Container(
                ...
                child: Center(
                  child: Column(
                    ...
                    Text("TUS",style: TextStyle(color: Colors.white,fontSize: 16),),
              ...
              child: Container(
                ...
                child: Center(
                  child: Column(
                    ...
                    Text("WED",style: TextStyle(color: Colors.white,fontSize: 16),),
              ...
              child: Container(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                    Text("JUN",style: TextStyle(color: Colors.white,fontSize: 16),),
                    Text("17",style: TextStyle(color: Colors.white,fontSize: 16),),
                    Text("THR",style: TextStyle(color: Colors.white,fontSize: 16),),
